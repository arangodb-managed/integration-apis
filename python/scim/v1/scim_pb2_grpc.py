...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in scim/v1/scim_pb2_grpc.py depends on'
...
def add_SCIMServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('arangodb.cloud.resourcemanager.v1.SCIMService', rpc_method_handlers)
