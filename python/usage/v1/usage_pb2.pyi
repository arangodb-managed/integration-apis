...
class UsageItem(_message.Message):
    ...
    class MLServicesSize(_message.Message):
        ...
        PREDICTION_APIS_FIELD_NUMBER: _ClassVar[int]
        PREDICTION_API_MEMORY_SIZE_FIELD_NUMBER: _ClassVar[int]
        PREDICTION_API_CPU_SIZE_FIELD_NUMBER: _ClassVar[int]
        PROJECTS_APIS_FIELD_NUMBER: _ClassVar[int]
        PROJECTS_API_MEMORY_SIZE_FIELD_NUMBER: _ClassVar[int]
        PROJECTS_API_CPU_SIZE_FIELD_NUMBER: _ClassVar[int]
        training_apis: int
        training_api_memory_size: int
        training_api_cpu_size: float
        prediction_apis: int
        prediction_api_memory_size: int
