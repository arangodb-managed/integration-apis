...
class SecurityService(object):
    ...
    def GetAPIVersion(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.security.v1.SecurityService/GetAPIVersion',
    ...
    def ListIPAllowlists(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.security.v1.SecurityService/ListIPAllowlists',
    ...
    def GetIPAllowlist(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.security.v1.SecurityService/GetIPAllowlist',
    ...
    def CreateIPAllowlist(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.security.v1.SecurityService/CreateIPAllowlist',
    ...
    def UpdateIPAllowlist(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.security.v1.SecurityService/UpdateIPAllowlist',
            security_dot_v1_dot_security__pb2.IPAllowlist.SerializeToString,
            security_dot_v1_dot_security__pb2.IPAllowlist.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteIPAllowlist(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.security.v1.SecurityService/DeleteIPAllowlist',
            common_dot_v1_dot_common__pb2.IDOptions.SerializeToString,
    ...
    def ListIAMProviders(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.security.v1.SecurityService/ListIAMProviders',
            common_dot_v1_dot_common__pb2.ListOptions.SerializeToString,
    ...
    def GetIAMProvider(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.security.v1.SecurityService/GetIAMProvider',
            common_dot_v1_dot_common__pb2.IDOptions.SerializeToString,
    ...
    def CreateIAMProvider(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.security.v1.SecurityService/CreateIAMProvider',
    ...
    def UpdateIAMProvider(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.security.v1.SecurityService/UpdateIAMProvider',
            security_dot_v1_dot_security__pb2.IAMProvider.SerializeToString,
            security_dot_v1_dot_security__pb2.IAMProvider.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteIAMProvider(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.security.v1.SecurityService/DeleteIAMProvider',
            common_dot_v1_dot_common__pb2.IDOptions.SerializeToString,
            common_dot_v1_dot_common__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SetDefaultIAMProvider(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.security.v1.SecurityService/SetDefaultIAMProvider',
            security_dot_v1_dot_security__pb2.IAMProvider.SerializeToString,
            common_dot_v1_dot_common__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
