...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in dashboard/v1/dashboard_pb2_grpc.py depends on'
...
class DashboardServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAPIVersion = channel.unary_unary(
                '/arangodb.cloud.dashboard.v1.DashboardService/GetAPIVersion',
        ...
        self.GetVersion = channel.unary_unary(
                '/arangodb.cloud.dashboard.v1.DashboardService/GetVersion',
                request_serializer=common_dot_v1_dot_common__pb2.Empty.SerializeToString,
                response_deserializer=common_dot_v1_dot_common__pb2.Version.FromString,
                _registered_method=True)
...
def add_DashboardServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'arangodb.cloud.dashboard.v1.DashboardService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('arangodb.cloud.dashboard.v1.DashboardService', rpc_method_handlers)
