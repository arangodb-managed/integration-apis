...
class ExampleDataset(_message.Message):
    __slots__ = ["created_at", "description", "guide", "id", "name", "url"]
...
class ExampleDatasetInstallation(_message.Message):
    __slots__ = ["created_at", "deleted_at", "deployment_id", "exampledataset_id", "id", "is_deleted", "status", "url"]
    class Status(_message.Message):
        __slots__ = ["database_name", "demo_url", "is_available", "is_failed", "state", "user_name"]
