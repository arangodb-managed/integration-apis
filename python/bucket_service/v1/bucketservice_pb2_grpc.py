...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in bucket_service/v1/bucketservice_pb2_grpc.py depends on'
...
def add_BucketServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('arangodb.cloud.integration.bucketservice.v1.BucketService', rpc_method_handlers)
