...
class PrivateEndpointService(_message.Message):
    __slots__ = ("id", "url", "name", "description", "created_at", "deleted_at", "is_deleted", "deployment_id", "alternate_dns_names", "enable_private_dns", "aks", "aws", "gcp", "status")
    ...
    class Status(_message.Message):
        __slots__ = ("ready", "ready_at", "needs_attention", "message", "private_dns_status", "private_dns_ready_at", "aks", "aws", "gcp")
        READY_FIELD_NUMBER: _ClassVar[int]
        READY_AT_FIELD_NUMBER: _ClassVar[int]
        NEEDS_ATTENTION_FIELD_NUMBER: _ClassVar[int]
        MESSAGE_FIELD_NUMBER: _ClassVar[int]
        PRIVATE_DNS_STATUS_FIELD_NUMBER: _ClassVar[int]
        PRIVATE_DNS_READY_AT_FIELD_NUMBER: _ClassVar[int]
        ...
        message: str
        private_dns_status: str
        private_dns_ready_at: _timestamp_pb2.Timestamp
        aks: PrivateEndpointService.AksStatus
        aws: PrivateEndpointService.AwsStatus
        gcp: PrivateEndpointService.GcpStatus
        def __init__(self, ready: bool = ..., ready_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., needs_attention: bool = ..., message: _Optional[str] = ..., private_dns_status: _Optional[str] = ..., private_dns_ready_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., aks: _Optional[_Union[PrivateEndpointService.AksStatus, _Mapping]] = ..., aws: _Optional[_Union[PrivateEndpointService.AwsStatus, _Mapping]] = ..., gcp: _Optional[_Union[PrivateEndpointService.GcpStatus, _Mapping]] = ...) -> None: ...
    ID_FIELD_NUMBER: _ClassVar[int]
    ...
    ENABLE_PRIVATE_DNS_FIELD_NUMBER: _ClassVar[int]
    AKS_FIELD_NUMBER: _ClassVar[int]
    AWS_FIELD_NUMBER: _ClassVar[int]
    GCP_FIELD_NUMBER: _ClassVar[int]
