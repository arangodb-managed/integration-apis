...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in audit/v1/audit_pb2_grpc.py depends on'
...
def add_AuditServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('arangodb.cloud.audit.v1.AuditService', rpc_method_handlers)
