...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in notebook/v1/notebook_pb2_grpc.py depends on'
...
def add_NotebookServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('arangodb.cloud.notebook.v1.NotebookService', rpc_method_handlers)
