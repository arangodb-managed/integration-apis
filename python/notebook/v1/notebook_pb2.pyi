...
class Notebook(_message.Message):
    __slots__ = ["id", "deployment_id", "url", "name", "description", "is_paused", "last_paused_at", "last_resumed_at", "created_by_id", "created_at", "model", "is_deleted", "deleted_at", "status"]
...
class NotebookModel(_message.Message):
    __slots__ = ["id", "name", "cpu", "memory", "max_disk_size", "min_disk_size"]
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class Status(_message.Message):
    __slots__ = ["phase", "message", "last_updated_at", "endpoint", "usage"]
    class Usage(_message.Message):
        __slots__ = ["data_volume_info", "last_memory_usage", "last_cpu_usage", "last_memory_limit", "last_cpu_limit"]
