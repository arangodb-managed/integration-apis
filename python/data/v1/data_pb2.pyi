...
class Deployment(_message.Message):
    ...
    class BackupRestoreStatus(_message.Message):
        __slots__ = ["revision", "restoring", "status", "failure_reason"]
    ...
    class BackupRestoreSpec(_message.Message):
        __slots__ = ["revision", "last_updated_at", "backup_id"]
        REVISION_FIELD_NUMBER: _ClassVar[int]
...
class NodeSizesRequest(_message.Message):
    __slots__ = ["project_id", "region_id", "deployment_id", "model", "organization_id"]
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    REGION_ID_FIELD_NUMBER: _ClassVar[int]
    DEPLOYMENT_ID_FIELD_NUMBER: _ClassVar[int]
    MODEL_FIELD_NUMBER: _ClassVar[int]
...
class Version(_message.Message):
    __slots__ = ["version", "replace_by", "upgrade_recommendation", "is_end_of_life"]
    VERSION_FIELD_NUMBER: _ClassVar[int]
...
class ListDiskPerformancesRequest(_message.Message):
    __slots__ = ["region_id", "node_size_id", "dbserver_disk_size", "deployment_id"]
    REGION_ID_FIELD_NUMBER: _ClassVar[int]
    NODE_SIZE_ID_FIELD_NUMBER: _ClassVar[int]
    DBSERVER_DISK_SIZE_FIELD_NUMBER: _ClassVar[int]
    DEPLOYMENT_ID_FIELD_NUMBER: _ClassVar[int]
