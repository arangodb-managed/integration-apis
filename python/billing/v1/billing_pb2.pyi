...
class Invoice(_message.Message):
    ...
    class Item(_message.Message):
        __slots__ = ("usageitem_ids", "amount", "description", "is_prepaid", "is_prepaid_credits")
        USAGEITEM_IDS_FIELD_NUMBER: _ClassVar[int]
        AMOUNT_FIELD_NUMBER: _ClassVar[int]
        DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
        IS_PREPAID_FIELD_NUMBER: _ClassVar[int]
        IS_PREPAID_CREDITS_FIELD_NUMBER: _ClassVar[int]
        usageitem_ids: _containers.RepeatedScalarFieldContainer[str]
        amount: float
        description: str
        is_prepaid: bool
        is_prepaid_credits: bool
        def __init__(self, usageitem_ids: _Optional[_Iterable[str]] = ..., amount: _Optional[float] = ..., description: _Optional[str] = ..., is_prepaid: bool = ..., is_prepaid_credits: bool = ...) -> None: ...
