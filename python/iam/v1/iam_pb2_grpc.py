...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in iam/v1/iam_pb2_grpc.py depends on'
...
def add_IAMServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('arangodb.cloud.iam.v1.IAMService', rpc_method_handlers)
