...
class Backup(_message.Message):
    __slots__ = ["id", "url", "name", "description", "deployment_id", "backup_policy_id", "created_at", "deleted_at", "is_deleted", "auto_deleted_at", "deployment_info", "upload", "upload_updated_at", "download", "status", "region_id", "source_backup_id"]
