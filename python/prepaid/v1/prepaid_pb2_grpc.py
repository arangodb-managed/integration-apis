...
class PrepaidService(object):
    ...
    def GetAPIVersion(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.prepaid.v1.PrepaidService/GetAPIVersion',
    ...
    def ListPrepaidDeployments(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.prepaid.v1.PrepaidService/ListPrepaidDeployments',
    ...
    def GetPrepaidDeployment(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.prepaid.v1.PrepaidService/GetPrepaidDeployment',
    ...
    def CreateDeployment(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.prepaid.v1.PrepaidService/CreateDeployment',
    ...
    def UpdateDeployment(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.prepaid.v1.PrepaidService/UpdateDeployment',
    ...
    def CloneDeploymentFromBackup(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arangodb.cloud.prepaid.v1.PrepaidService/CloneDeploymentFromBackup',
