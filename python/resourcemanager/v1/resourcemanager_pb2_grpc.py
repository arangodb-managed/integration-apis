...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in resourcemanager/v1/resourcemanager_pb2_grpc.py depends on'
...
def add_ResourceManagerServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('arangodb.cloud.resourcemanager.v1.ResourceManagerService', rpc_method_handlers)
