...
class CACertificate(_message.Message):
    __slots__ = ["certificate_pem", "cloned_from_id", "created_at", "deleted_at", "description", "expires_at", "id", "is_default", "is_deleted", "is_expired", "lifetime", "locked", "name", "project_id", "rotation_needed", "url", "use_well_known_certificate", "will_expire_soon"]
...
class CACertificateInstructions(_message.Message):
    ...
    class PlatformInstructions(_message.Message):
        __slots__ = ["install_steps", "platform", "uninstall_steps"]
...
class ListCACertificatesRequest(_message.Message):
    __slots__ = ["cloned_from_id", "options", "project_id"]
    CLONED_FROM_ID_FIELD_NUMBER: _ClassVar[int]
